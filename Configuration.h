...
#define STRING_CONFIG_H_AUTHOR "(G.van Den Berg Holland)" // Who made the changes.
...
//#define BAUDRATE_2    // Enable to override BAUDRATE
...
#define CUSTOM_MACHINE_NAME "tronxy x5sa 2E smart 2.0"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 431.8, 431.8 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          {150, 150, 40, 40, 40 }
...
#define BLTOUCH
#if ENABLED (BLTOUCH)
#define BLTOUCH_RELAY 100 // (ms) Enable and increase if needed
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -38, 6, -2.39 }
...
//#define PRINTCOUNTER
  ...
  #define PRINTCOUNTER_AVE_INTERVAL 60 // (minutes) EEPROM save interval during print
#endif
